const Master = {
  async render() {
    ...
    <div class="flex flex-col gap-2 mt-2">
      <a
          href="#/master/admins"
          class="flex max-w-sm items-center justify-center rounded-lg bg-gray-50 p-4 text-gray-800 ring-1 ring-gray-200 hover:bg-gray-100 hover:text-gray-900 dark:bg-gray-800 dark:text-gray-200 dark:ring-gray-700 dark:hover:bg-gray-700 dark:hover:text-white"
        >
