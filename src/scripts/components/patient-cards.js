  ...
  render() {
    ...
    this.innerHTML = `
      <div class="flex flex-wrap gap-4 ${animatePulseClass}">
        ...
        <div
          class="grid grid-cols-[2fr_1fr] grid-rows-2 place-items-start rounded-md bg-gray-300 p-4 font-semibold text-gray-700 ring-1 ring-gray-400 dark:bg-gray-800 dark:text-gray-300"
        >
        ...
        <div
          class="grid grid-cols-[2fr_1fr] grid-rows-2 place-items-start rounded-md bg-gray-50 p-4 font-semibold text-gray-700 ring-1 ring-gray-400 dark:bg-gray-800 dark:text-gray-300"
        >
